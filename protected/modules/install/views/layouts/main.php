    ...
    <head>
        ...
        <link href='http://fonts.googleapis.com/css?family=Roboto:400,300,700,500&subset=latin,cyrillic-ext,greek-ext,greek,vietnamese,latin-ext,cyrillic' rel='stylesheet' type='text/css'>
            ...
            <style type="text/css">
                ...
                div.form .row, .form-group {margin: 0px 0;}
                div.form input, div.form textarea, div.form select {margin: 0 0 0.5em 0;}
                div.form .license-block {margin: 10px 0 0 0;}
        ...
        <div id="container">
            <div class="logo">
                <a title="" href="<?php echo Yii::app()->controller->createAbsoluteUrl('/'); ?>">
                    ...
                    <div class="logo-text">Open Real Estate CMS</div>
                </a>
            </div>
