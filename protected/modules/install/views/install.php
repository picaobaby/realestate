...
<div class="form">
    ...
    <div class="custom-info-block">
        ...
        <?php if (Yii::app()->language == 'ru'):?>
            <a href="https://open-real-estate.info/ru/system-requirements" target="_blank">Системные требования</a>
        <?php else:?>
            <a href="https://open-real-estate.info/en/system-requirements" target="_blank">System requirements</a>
        <?php endif;?>
            
        <?php if (Yii::app()->language == 'ru'):?>
            <a href="https://open-real-estate.info/ru/faq" target="_blank">FAQ</a>
        <?php else:?>
            <a href="https://open-real-estate.info/en/faq" target="_blank">FAQ</a>
        <?php endif;?>
