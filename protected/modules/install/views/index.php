<div class="install-select-lang">
    ...
    <div class="span-12" align="left">
        <a href="<?php echo $this->createUrl('config', array('lang' => 'ru')); ?>">
            <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/flag_ru.gif" alt="Russian / Русский / Russisch / Ruso / Rus" />
        </a>
        <div align="left">
            <a href="<?php echo $this->createUrl('config', array('lang' => 'ru')); ?>">
    ...
    <div class="span-12" align="right">
        <a href="<?php echo $this->createUrl('config', array('lang' => 'en')); ?>">
            <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/flag_us.gif" alt="English / Английский / Englisch / Inglés / İngiliz" />
        </a>
        <div align="right">
            <a href="<?php echo $this->createUrl('config', array('lang' => 'en')); ?>">
    ...
    <div class="span-12" align="left">
        <a href="<?php echo $this->createUrl('config', array('lang' => 'de')); ?>">
            <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/flag_de.gif" alt="German / Немецкий / Deutsch / Alemán / Alman" />
        </a>
        <div align="left">
            <a href="<?php echo $this->createUrl('config', array('lang' => 'de')); ?>">
    ...
    <div class="span-12" align="right">
        <a href="<?php echo $this->createUrl('config', array('lang' => 'es')); ?>">
            <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/flag_es.gif" alt="Spanish / Испанский / Spanisch / Español / İspanyol" />
        </a>
        <div align="right">
            <a href="<?php echo $this->createUrl('config', array('lang' => 'es')); ?>">
    ...
    <div class="span-12" align="left">
        <a href="<?php echo $this->createUrl('config', array('lang' => 'ar')); ?>">
            <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/flag_sa.gif" alt="Arab / Арабский / Arabisch / Árabe / Arap" />
        </a>
        <div align="left">
            <a href="<?php echo $this->createUrl('config', array('lang' => 'ar')); ?>">
    ...
    <div class="span-12" align="right">
        <a href="<?php echo $this->createUrl('config', array('lang' => 'tr')); ?>">
            <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/flag_tr.gif" alt="Turkish / Турецкий / Türkisch / Turca / تركي / Türk" />
        </a>
        <div align="right">
            <a href="<?php echo $this->createUrl('config', array('lang' => 'tr')); ?>">
