    ...
    <div class="row">  
        <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="small-box bg-light-blue-active">
                ...
                <a href="<?php echo $baseUrl . '/configuration/backend/main/admin#setting_useReCaptcha'; ?>" class="small-box-footer"><?php echo tc('Go to'); ?> <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <div class="small-box bg-orange-active">
                ...
                <a href="https://open-real-estate.info/<?php echo $langPrefix; ?>/blog/instructions/unusual-way-open-real-estate-script-usage" target="_blank" class="small-box-footer"><?php echo tc('Go to'); ?> <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
