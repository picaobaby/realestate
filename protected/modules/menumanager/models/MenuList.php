...
class MenuList extends ParentModel
{
    ...
    const ID_TOP_BASIS_1 = 3;
    const ID_TOP_BASIS_2 = 4;
    const ID_TOP_BASIS_3 = 5;
    ...
    public function search()
    {
        ...
        if (!in_array('basis', Themes::getDBTemplatesList())) {
            $criteria->addNotInCondition('id', array(MenuList::ID_TOP_BASIS_1, MenuList::ID_TOP_BASIS_2, MenuList::ID_TOP_BASIS_3));
        }
